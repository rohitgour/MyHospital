 ...
 * @author HP
 */
public class ViewAllEmpDetails extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllEmpDetails
     */
    public ViewAllEmpDetails() {
        initComponents();
    ...
    private void showEmpData()
    {
        try
        {
            ArrayList<EmpPojo> emplist=EmpDao.getAllEmployeeDetails();
    ...
    private void initComponents() {
        ...
        jtEmpData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employees Id", "Employee Name", "Job", "Salary", "Active"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        manageEmployeeframe f = new manageEmployeeframe();
        f.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllEmpDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllEmpDetails().setVisible(true);
            }
        });
    }
